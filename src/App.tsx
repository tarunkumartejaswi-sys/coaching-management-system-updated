...
export default function App() {
  ...
  /* =========================================================
     FEE ACTION PAGES
  ========================================================= */
  const feeBack = () => setPage(selectedFeeStudent ? "feeDetail" : "fees");
